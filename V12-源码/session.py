...
# ============================================================
try:
    from advanced_runner import CDPEngine, OCREngine, ImageMatcher, EventBus
except ImportError:
    ...
    class ImageMatcher:
        ...
        async def find_element(self, *a): return None
    class OCREngine:
        def __init__(self, page, eb): self.available = False
        async def find_text(self, *a): return {"found": False}
...
class BrowserSession:
    ...
    async def _detect_existing(cls, port=18800):
        ...
        try:
            ...
            try:
                ...
                if instance.page:
                    await instance.cdp.connect(instance.page, browser=instance._browser if hasattr(instance, '_browser') else None)
    ...
    async def _start(self):
        ...
        await self.cdp.connect(self.page, browser=self._context.browser if hasattr(self._context, 'browser') else None)
        ...
        print(f"        采集: python debug_elements-V11.py --cdp http://127.0.0.1:18800")
