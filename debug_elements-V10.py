...
集成方式：
  1. 作为独立工具：python debug_elements.py --cdp http://127.0.0.1:9222
...
async def collect_elements(
    ...
    Args:
        cdp_url: 浏览器 CDP URL，如 http://127.0.0.1:9222，不指定则自动发现
        output_file: 输出文件路径
...
async def main_async():
    ...
    parser.add_argument("--cdp", help="CDP URL，如 http://127.0.0.1:9222")
